...
function performLfmRequest(url, parameter, type) {
    ...
    // Pencegahan akses tidak sengaja ke route internal Livewire
    if ((lfm_route + "/" + url).includes("/livewire/update")) {
        console.error("⚠️ Diblokir: percobaan akses ke /livewire/update!");
        return;
    }
